...
A fully functional AI-powered customer support agent for e-commerce refund processing.

## Stack
| Layer | Technology |
|-------|-----------|
| LLM | [Groq API](https://console.groq.com) - Llama 3.3 70B |
...
- Agent retrieves and explains the full policy
